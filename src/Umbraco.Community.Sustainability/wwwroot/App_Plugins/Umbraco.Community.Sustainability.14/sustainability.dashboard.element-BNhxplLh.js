 ...
 */
const H = globalThis, I = H.ShadowRoot && (H.ShadyCSS === void 0 || H.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, tt = Symbol(), W = /* @__PURE__ */ new WeakMap();
let at = class {
  constructor(t, e, s) {
...
const lt = (r) => new at(typeof r == "string" ? r : r + "", void 0, tt), ct = (r, t) => {
  if (I)
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: dt, defineProperty: pt, getOwnPropertyDescriptor: ut, getOwnPropertyNames: $t, getOwnPropertySymbols: _t, getPrototypeOf: ft } = Object, f = globalThis, q = f.trustedTypes, At = q ? q.emptyScript : "", j = f.reactiveElementPolyfillSupport, S = (r, t) => r, N = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? At : null;
      break;
  ...
  return e;
} }, B = (r, t) => !dt(r, t), J = { attribute: !0, type: String, converter: N, reflect: !1, hasChanged: B };
...
g.elementStyles = [], g.shadowRootOptions = { mode: "open" }, g[S("elementProperties")] = /* @__PURE__ */ new Map(), g[S("finalized")] = /* @__PURE__ */ new Map(), j == null || j({ ReactiveElement: g }), (f.reactiveElementVersions ?? (f.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const w = globalThis, M = w.trustedTypes, K = M ? M.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, et = "$lit$", _ = `lit$${(Math.random() + "").slice(9)}$`, st = "?" + _, mt = `<${st}>`, y = document, C = () => y.createComment(""), U = (r) => r === null || typeof r != "object" && typeof r != "function", it = Array.isArray, yt = (r) => it(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function", L = `[ 	
\f\r]`, b = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Z = /-->/g, F = />/g, A = RegExp(`>|${L}(?:([^\\s"'>=/]+)(${L}*=${L}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), G = /'/g, Q = /"/g, rt = /^(?:script|style|textarea|title)$/i, gt = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), vt = gt(1), v = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), X = /* @__PURE__ */ new WeakMap(), m = y.createTreeWalker(y, 129);
function nt(r, t) {
...
const Et = (r, t) => {
  ...
  for (let a = 0; a < e; a++) {
    ...
    for (; u < h.length && (n.lastIndex = u, p = n.exec(h), p !== null); )
      u = n.lastIndex, n === b ? p[1] === "!--" ? n = Z : p[1] !== void 0 ? n = F : p[2] !== void 0 ? (rt.test(p[2]) && (i = RegExp("</" + p[2], "g")), n = A) : p[3] !== void 0 && (n = A) : n === A ? p[0] === ">" ? (n = i ?? b, l = -1) : p[1] === void 0 ? l = -2 : (l = n.lastIndex - p[2].length, c = p[1], n = p[3] === void 0 ? A : p[3] === '"' ? Q : G) : n === Q || n === G ? n = A : n === Z || n === F ? n = b : (n = A, i = void 0);
    const $ = n === A && r[a + 1].startsWith("/>") ? " " : "";
    o += n === b ? h + mt : l >= 0 ? (s.push(c), h.slice(0, l) + et + h.slice(l) + _ + $) : h + _ + (l === -2 ? a : $);
  }
      ...
      if (i.nodeType === 1) {
        if (i.hasAttributes())
          for (const l of i.getAttributeNames())
            if (l.endsWith(et)) {
              ...
              h.push({ type: 1, index: o, name: T[2], strings: $, ctor: T[1] === "." ? St : T[1] === "?" ? wt : T[1] === "@" ? Pt : D }), i.removeAttribute(l);
            } else
        ...
        if (rt.test(i.tagName)) {
          ...
          if (u > 0) {
            ...
            for (let $ = 0; $ < u; $++)
              i.append(l[$], C()), m.nextNode(), h.push({ type: 2, index: ++o });
            i.append(l[u], C());
          }
        }
...
class O {
  ...
  _$AI(t, e = this) {
    t = E(this, t, e), U(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== v && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : yt(t) ? this.k(t) : this._(t);
  }
  S(t) {
  ...
  $(t) {
    var o;
    const { values: e, _$litType$: s } = t, i = typeof s == "number" ? this._$AC(t) : (s.el === void 0 && (s.el = x.createElement(nt(s.h, s.h[0]), this.options)), s);
...
k == null || k(x, O), (w.litHtmlVersions ?? (w.litHtmlVersions = [])).push("3.1.2");
const Ut = (r, t, e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ot = { attribute: !0, type: String, converter: N, reflect: !1, hasChanged: B }, Tt = (r = Ot, t, e) => {
...
var Mt = Object.defineProperty, Rt = Object.getOwnPropertyDescriptor, ot = (r, t, e, s) => {
  for (var i = s > 1 ? void 0 : s ? Rt(t, e) : t, o = r.length - 1, n; o >= 0; o--)
    (n = r[o]) && (i = (s ? n(t, e, i) : n(i)) || i);
  return s && i && Mt(t, e, i), i;
};
const Dt = "sustainability-overview-dashboard";
let R = class extends ht(P) {
  constructor() {
    super(), this._routes = [
      {
        path: "",
        component: () => import("./sustainability-overview.element-w_3pzn_S.js")
      }
    ];
  }
  render() {
    return vt`<umb-router-slot .routes=${this._routes}></umb-router-slot>`;
  }
};
ot([
  Nt()
...
//# sourceMappingURL=sustainability.dashboard.element-BNhxplLh.js.map
