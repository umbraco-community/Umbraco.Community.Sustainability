...
var c = (t, e, a) => (j(t, e, "read from private field"), a ? a.call(t) : e.get(t)), p = (t, e, a) => {
  if (e.has(t))
    throw TypeError("Cannot add the same private member more than once");
  e instanceof WeakSet ? e.add(t) : e.set(t, a);
}, b = (t, e, a, i) => (j(t, e, "write to private field"), i ? i.call(t, a) : e.set(t, a), a);
...
import { LitElement as Y, html as J, property as K, customElement as X } from "@umbraco-cms/backoffice/external/lit";
const Q = {
  type: "workspaceView",
  alias: "Umbraco.Community.Sustainability.Workspace",
  name: "Sustainability Workspace",
  js: () => import("./sustainability-workspace-view-CiHgsDZD.js"),
  weight: 10,
  meta: {
    icon: "icon-eco",
  ...
  js: () => import("./overview-workspace.element-BAZ0FFpQ.js"),
  meta: {
    entityType: q
  }
}, ne = {
  ...
  js: () => import("./stats-workspace.element-Ug3H0Tey.js"),
  meta: {
    entityType: B
  }
}, ye = [
  ...
  ...ye,
  ...le
], D = "Umb.Section.Sustainability", $ = "Umb.Menu.Sustainability", he = {
  type: "section",
  alias: D,
...
const m = {
...
}, T = (t) => typeof t == "string", E = (t) => T(t) && t !== "", C = (t) => t instanceof Blob, H = (t) => t instanceof FormData, ve = (t) => {
  try {
    return btoa(t);
  } catch {
  ...
  const e = [], a = (s, n) => {
    ...
    n != null && (n instanceof Date ? a(s, n.toISOString()) : Array.isArray(n) ? n.forEach((r) => i(s, r)) : typeof n == "object" ? Object.entries(n).forEach(([r, o]) => i(`${s}[${r}]`, o)) : a(s, n));
  };
  ...
  return e.body !== void 0 && (e.mediaType ? r["Content-Type"] = e.mediaType : C(e.body) ? r["Content-Type"] = e.body.type || "application/octet-stream" : T(e.body) ? r["Content-Type"] = "text/plain" : H(e.body) || (r["Content-Type"] = "application/json")), new Headers(r);
}, Re = (t) => {
  var e, a;
  if (t.body !== void 0)
    return (e = t.mediaType) != null && e.includes("application/json") || (a = t.mediaType) != null && a.includes("+json") ? JSON.stringify(t.body) : T(t.body) || C(t.body) || H(t.body) ? t.body : JSON.stringify(t.body);
...
}, w = (t, e) => new we(async (a, i, s) => {
  try {
    const n = _e(t, e), r = De(e), o = Re(e), h = await Ee(t, e);
    if (!s.isCancelled) {
      let l = await Ae(t, e, n, o, r, h, s);
      for (const V of t.interceptors.response._fns)
        l = await V(l);
      const O = await Oe(l), W = Ce(l, e.responseHeader);
      let P = O;
      e.responseTransformer && l.ok && (P = await e.responseTransformer(O));
      const I = {
        url: n,
        ok: l.ok,
        status: l.status,
...
class R extends k {
  constructor(a) {
    ...
    p(this, f, void 0);
    p(this, g, void 0);
    b(this, f, new N(void 0)), this.overviewData = c(this, f).asObservable(), b(this, g, new N(void 0)), this.averageData = c(this, g).asObservable(), b(this, y, new je(this));
  }
...
const M = new F("SustainabilityContext"), Ne = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  SUSTAINABILITY_CONTEXT: M,
  SustainabilityContext: R,
  default: R
}, Symbol.toStringTag, { value: "Module" }));
var Ue = Object.defineProperty, xe = Object.getOwnPropertyDescriptor, L = (t, e, a, i) => {
  for (var s = i > 1 ? void 0 : i ? xe(e, a) : e, n = t.length - 1, r; n >= 0; n--)
    (r = t[n]) && (s = (i ? r(e, a, s) : r(s)) || s);
  return i && s && Ue(e, a, s), s;
};
const ke = "sustainability-carbon-rating";
let A = class extends z(Y) {
  constructor() {
...
//# sourceMappingURL=index-BOus3T3d.js.map
